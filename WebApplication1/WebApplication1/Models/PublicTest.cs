...
namespace Aop.Api.Test
{
    ...
    internal class DefaultAopClient : IAopClient
    {
    ...
    internal interface IAopClient
    {
    }

    internal class AlipaySignature
    {
        internal static string CheckSignAndDecrypt(IDictionary<string, string> paramsMap, string publicKeyPem, string privateKeyPem, bool v1, bool v2)
        {
            throw new NotImplementedException();
        }

        internal static bool RSACheckV2(IDictionary<string, string> paramsMap, string publicKey)
        {
            throw new NotImplementedException();
        }

        internal static string RSAEncrypt(string bizContent, string publicKeyPem, string charset)
        {
            throw new NotImplementedException();
        }

        internal static string RSASign(IDictionary<string, string> paramsMap, string privateKeyPem, object p)
        {
            throw new NotImplementedException();
        }
    }
